...
| GearDrsErs | 1 | gear[0:4] · **ERS mode**[4:6] (2-bit) · **DRS**[6] (1-bit) | ERS mode 0–3, DRS 0/1. The brake dash (`02`) DRS toggle is **not** driven by this bit — PitHouse can't light it either (firmware) |
