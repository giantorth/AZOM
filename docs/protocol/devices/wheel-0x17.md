...
| Int8 / Gear / Temperature / Float8 | 1 | 8-bit | gear = **SimHub gear + 1** (0 = R, 1 = N, 2 = 1st); tyre wear = **100 − SimHub wear %** (gauge shows remaining, tester-verified) |
